...
interface UseModalAnimationProps {
    ...
    ready?: boolean; // prop: cuando el contenido está listo
}
...
export const useModalAnimation = ({
    ...
    useEffect(() => {
        ...
        if (!modal || !ready) return; // no animar hasta que esté listo el contenido
    ...
    }, [isOpen, ready, modalRef, onCloseAnimationEnd]);
};
